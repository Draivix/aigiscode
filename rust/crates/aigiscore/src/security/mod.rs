...
fn find_dangerous_api_findings(
    ...
    let code_lines = crate::lexmask::mask_non_code_spans(mask_language(language), content);
...
/// Map the security scanner's language enum to the shared lexical masker.
fn mask_language(language: SourceLanguage) -> crate::lexmask::MaskLanguage {
    match language {
        SourceLanguage::Php => crate::lexmask::MaskLanguage::Php,
        SourceLanguage::Python => crate::lexmask::MaskLanguage::Python,
        SourceLanguage::Ruby => crate::lexmask::MaskLanguage::Ruby,
        SourceLanguage::JavaScript => crate::lexmask::MaskLanguage::JavaScript,
        SourceLanguage::TypeScript => crate::lexmask::MaskLanguage::TypeScript,
    }
}
